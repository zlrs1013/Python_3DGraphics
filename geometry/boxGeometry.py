"""
    an extension of the Geometry class to describe the shape of a
    three-dimensional box; vertex colors are assigned so that each face of the
    box has a different solid color.
"""
